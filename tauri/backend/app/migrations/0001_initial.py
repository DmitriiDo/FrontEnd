# Generated by Django 4.2.7 on 2025-01-06 13:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ComponentRocket',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('count', models.IntegerField(default=0)),
                ('component', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.component')),
                ('rocket', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.rocket')),
            ],
            options={
                'verbose_name': 'м-м',
        ...
        migrations.AddConstraint(
            model_name='componentrocket',
            constraint=models.UniqueConstraint(fields=('component', 'rocket'), name='component_rocket_constraint'),
        ),
    ]
